...
wb = webull()
trigger = OrTrigger([CronTrigger(hour="12", minute="30"), CronTrigger(hour="15", minute="00"),
...
if __name__ == '__main__':
    ...
    bot = lightbulb.BotApp(token='MTAwMDgwMTc3MDcyMjgzNjYyMQ.GZeC6Q.qwoSIyDb_PpSksPz35Oqlost-1K2i6K5UJCdwQ',
